...
internal fun OneListTextField(
    ...
    BasicTextField(
        ...
        keyboardActions = KeyboardActions(onDone = { onKeyboardDoneInput() }),
        ...
        TextFieldDefaults.DecorationBox(
            ...
            colors = TextFieldDefaults.colors(
                focusedContainerColor = if (showBorder) MaterialTheme.appColors.textFieldColors.focusedContainerColor else MaterialTheme.appColors.textFieldBackgroundNoBorder,
                unfocusedContainerColor = if (showBorder) MaterialTheme.appColors.textFieldColors.unfocusedContainerColor else MaterialTheme.appColors.textFieldBackgroundNoBorder,
            ...
            placeholder = {
                Text(text = placeholder, color = MaterialTheme.appColors.textFieldPlaceholder)
            }
        )
    }
}
