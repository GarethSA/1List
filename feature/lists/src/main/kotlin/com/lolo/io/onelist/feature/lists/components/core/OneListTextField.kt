...
internal fun OneListTextField(
    ...
    // Reset key forces a brand-new BasicTextField when value is cleared,
    // flushing the IME buffer completely so no stale text can come back.
    val resetKey = if (singleLine) value.isEmpty() else false
